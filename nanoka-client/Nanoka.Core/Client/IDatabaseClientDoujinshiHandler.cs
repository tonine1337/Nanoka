...
namespace Nanoka.Core.Client
{
    public interface IDatabaseClientDoujinshiHandler
    {
        ...
        Task<UploadState<Doujinshi>> UploadAsync(DoujinshiBase doujinshi, DoujinshiVariantBase variant, ZipArchive archive, CancellationToken cancellationToken = default);
        ...
        Task<UploadState<DoujinshiVariant>> UploadVariantAsync(Doujinshi doujinshi, DoujinshiVariantBase variant, ZipArchive archive, CancellationToken cancellationToken = default);

        Task DeleteVariantAsync(Doujinshi doujinshi, DoujinshiVariant variant, CancellationToken cancellationToken = default);
    }
}